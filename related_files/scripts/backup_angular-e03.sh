...
source=/var/www/html/d002/angular-e03
destination=/home/Exercises/angular-e03/related_files/publication
rm $destination/*.tar.gz
tar -czvf $destination/pub_angular-e03_`(date +%Y%m%d-%H%M)`.tar.gz $source/

source=/home/Exercises/angular-e03/
destination=/home/Backups/angular-e03_`(date +%Y%m%d-%H%M)`.tar.gz
